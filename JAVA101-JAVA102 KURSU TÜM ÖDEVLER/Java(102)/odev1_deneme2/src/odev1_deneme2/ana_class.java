...
/**
*
* @author BAŞAK ŞEKER mail: basak.seker.551@gmail.com
* @since 21/04/2023 son değişiklik 23/04/2023
* <p>
* *javadoc dosyasındaki fonksiyonları bulan sonra da her fonskiyona ait yorum türlerini bulan program
* </p>
*/
public class ana_class 
{
	...
	public static void main(String[] args) {
         ...
         String filename = args[0]; // *.java dosya adı
	             ...
	             BufferedWriter multiLineWriter = new BufferedWriter(new FileWriter("coksatir.txt"))) 
	        {
	            for (String function : functions) {// öncesinde oluşturduğumuz listte dönsün
	                ...
	                System.out.println("Cok satir yorum sayisi:  "+ multiLineCommentCount);
